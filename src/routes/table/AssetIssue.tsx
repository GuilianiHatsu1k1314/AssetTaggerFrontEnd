...
const columns = [
  ...
  columnHelper.accessor("assetIssueTitle", {
    cell: (info) => (
      <span className="font-medium text-red-600">{info.getValue()}</span>
    ),
    header: "Title",
  }),
  columnHelper.accessor("assetIssueDescription", {
    cell: (info) => (
      <span
  ...
  columnHelper.accessor("assetIssueDate", {
  ...
  columnHelper.accessor("assetId", {
    ...
    header: "Asset ID (Target)",
  }),
  columnHelper.accessor("employeeId", {
    cell: (info) => <span className="text-gray-500">{info.getValue()}</span>,
    header: "Reported By (Emp ID)",
  }),
];
    ...
    <div className="flex h-screen w-full flex-col bg-gray-50 md:flex-row">
      ...
      <main className="flex-1 overflow-y-auto p-4 pb-28 md:p-8">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm font-medium text-gray-500 md:text-base">
          ...
          <span>/</span>
          <span className="text-gray-900">Asset Issue Display</span>
        </div>
        ...
        <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              View and manage reported problems and hardware failures.
            </p>
          </div>
            ...
            <div className="relative">
              ...
              {isFilterOpen && (
                <div className="absolute top-full right-0 z-50 mt-2 w-56 rounded-lg border border-gray-200 bg-white py-2 shadow-xl">
                  ...
                  <SortMenuItem
                    columnId="assetIssueDate"
                    label="Issue Date"
                    table={table}
                  />
                  <SortMenuItem
                    columnId="assetIssueTitle"
                    label="Title (A-Z)"
                    table={table}
                  />
                  <SortMenuItem
              ...
              <tbody className="divide-y divide-gray-100 bg-white">
                {table.getRowModel().rows.map((row) => (
                  <tr
                    ...
                    key={row.id}
                    onClick={() => {
                      handleRowClick(row.original.assetIssueId);
                    }}
                  >
                ...
                {table.getRowModel().rows.length === 0 && (
                  <tr>
                    ...
                    >
                      No asset issues found. Click "Report Issue" to log one.
                    </td>
                  </tr>
                )}
              </tbody>
