...
// 1. Correctly import the hook and type from the new DatabaseContext
import { type Asset, useDatabase } from "../context/-AssetContext";
...
function AssetPage() {
  ...
  // 3. Get live data specifically for the Asset table!
  ...
  const toggleEditMode = () => {
    ...
    sessionStorage.setItem("Asset_isEditMode", String(newValue));
  };
  // ==========================================
  ...
  const handleRowClick = (assetId: string) => {
    if (isEditMode) {
      navigate({
        search: { id: assetId, tableName: "Asset" },
        to: "/EditValue" as any,
      });
      // Removed setIsEditMode(false) so it stays sticky!
    }
  };
    ...
    <div className="flex h-screen w-full flex-col bg-gray-50 md:flex-row">
      ...
      <main className="flex-1 overflow-y-auto p-4 pb-28 md:p-8">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm font-medium text-gray-500 md:text-base">
          ...
          <span>/</span>
          <span className="text-gray-900">Asset Display</span>
        </div>
        ...
        <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Manage your registered assets, warranties, and lifespans.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              onClick={toggleEditMode} // <-- Calls Sticky Edit Mode Toggle
            >
              <svg
                fill="none"
                height="16"
