...
const columns = [
  ...
  columnHelper.accessor("endUserName", {
    cell: (info) => (
  ...
  columnHelper.accessor("employeeId", {
    ...
    header: "Linked Employee ID",
  }),
  columnHelper.accessor("endUserRegisterDate", {
      ...
      <div className="flex h-screen w-full flex-col bg-gray-50 md:flex-row">
        ...
        <main className="flex-1 overflow-y-auto p-4 pb-28 md:p-8">
          ...
          <div className="mb-6 flex items-center gap-2 text-sm font-medium text-gray-500 md:text-base">
            ...
            <span>/</span>
            <span className="text-gray-900">End User Display</span>
          </div>
          ...
          <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Manage system access accounts and linked employees.
              </p>
            </div>
              ...
              <div className="relative">
                ...
                {isFilterOpen && (
                  <div className="absolute top-full right-0 z-50 mt-2 w-56 rounded-lg border border-gray-200 bg-white py-2 shadow-xl">
                    ...
                    />
                    <SortMenuItem
                      columnId="endUserRegisterDate"
                      label="Registration Date"
                      table={table}
                    />
                    <SortMenuItem
                      columnId="endUserRoleId"
                      label="Role ID"
                      table={table}
                    />
                  </div>
                ...
                <tbody className="divide-y divide-gray-100 bg-white">
                  {table.getRowModel().rows.map((row) => (
                    <tr
                      ...
                      key={row.id}
                      onClick={() => {
                        handleRowClick(row.original.endUserId);
                      }}
                    >
                  ...
                  {table.getRowModel().rows.length === 0 && (
                    <tr>
                      ...
                      >
                        No users found. Click "Add End User" to register one.
                      </td>
                    </tr>
                  )}
                </tbody>
