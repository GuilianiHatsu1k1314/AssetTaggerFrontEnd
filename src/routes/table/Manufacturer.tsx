...
const columns = [
  ...
  columnHelper.accessor("manufacturerInsertDate", {
...
function ManufacturerPage() {
  ...
  const handleRowClick = (manufacturerId: string) => {
    if (isEditMode) {
      ...
      navigate({ search: { manufacturerId }, to: "/EditValue" as any });
      setIsEditMode(false);
    }
  };
    ...
    <div className="flex h-screen w-full flex-col bg-gray-50 md:flex-row">
      ...
      <main className="flex-1 overflow-y-auto p-4 pb-28 md:p-8">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm font-medium text-gray-500 md:text-base">
          ...
          <span>/</span>
          <span className="text-gray-900">Manufacturer Display</span>
        </div>
        ...
        <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Manage original equipment manufacturers and brands.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Link
              ...
              to="/AddValue" // Can redirect to specific Add Manufacturer form later
            >
              <svg
                fill="none"
                height="16"
              ...
              {isFilterOpen && (
                <div className="absolute top-full right-0 z-50 mt-2 w-56 rounded-lg border border-gray-200 bg-white py-2 shadow-xl">
                  ...
                  <SortMenuItem
                    ...
                    label="Manufacturer Name (A-Z)"
                    table={table}
                  />
                  <SortMenuItem
                    columnId="manufacturerInsertDate"
                    label="Date Added"
                    table={table}
                  />
                </div>
              ...
              <tbody className="divide-y divide-gray-100 bg-white">
                {table.getRowModel().rows.map((row) => (
                  <tr
                    ...
                    key={row.id}
                    onClick={() => {
                      handleRowClick(row.original.manufacturerId);
                    }}
                  >
