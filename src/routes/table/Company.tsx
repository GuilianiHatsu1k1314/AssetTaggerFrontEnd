...
const columns = [
  ...
  columnHelper.accessor("companyCode", {
    cell: (info) => (
      <span className="rounded border border-gray-200 bg-gray-100 px-2 py-1 font-mono text-sm font-bold text-gray-700">
        {info.getValue()}
      </span>
    ),
    header: "Code",
  ...
  columnHelper.accessor("parentCompanyId", {
    cell: (info) => {
  ...
  columnHelper.accessor("companyInsertDate", {
    ...
    <div className="flex h-screen w-full flex-col bg-gray-50 md:flex-row">
      ...
      <main className="flex-1 overflow-y-auto p-4 pb-28 md:p-8">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm font-medium text-gray-500 md:text-base">
          ...
          <span>/</span>
          <span className="text-gray-900">Company Display</span>
        </div>
        ...
        <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Manage parent companies, subsidiaries, and business entities.
            </p>
          </div>
              ...
              <tbody className="divide-y divide-gray-100 bg-white">
                {table.getRowModel().rows.map((row) => (
                  <tr
                    ...
                    key={row.id}
                    onClick={() => {
                      handleRowClick(row.original.companyId);
                    }}
                  >
